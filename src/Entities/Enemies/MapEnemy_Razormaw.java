...
public class MapEnemy_Razormaw extends EnemyEntity {
    ...
    public void loadFrames() {
        for (int i = 0; i < 4; i++) {
            walkLeft[i]  = loadFrame("/enemies/razormaw/razormaw_walking/walking_left"  + (i + 1) + ".png");
            walkRight[i] = loadFrame("/enemies/razormaw/razormaw_walking/walking_right" + (i + 1) + ".png");
        }
