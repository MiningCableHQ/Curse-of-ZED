...
public class Clumsiness extends Consumable {
    protected double speedDebuffMultiplier;

    public Clumsiness() {
        super("Clumsiness Potion", "Reduces enemy SPD by 10%");
        speedDebuffMultiplier = 0.90;
        useMessage = "Used Clumsiness Potion!";

        loadImage("/items/debuff_potions/clumsiness_potion.png");
    }
    ...
    public <T> void useItem(T Entity) {
        if (Entity instanceof Enemy) {
            ...
            useMessage = "Used Clumsiness Potion on " + target.getName() + "! SPD reduced by " +
